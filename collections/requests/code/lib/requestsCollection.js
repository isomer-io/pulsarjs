 ...
 */
Requests = new orion.collection('requests', {
    singularName: 'request', // The name of one of these items
    pluralName: 'requests', // The name of more than one of these items
...
/*
    Now we will attach the schema for the requests collection.
 ...
 */
Requests.findList = new Meteor.Pagination(Requests, {
    infinite: true,
