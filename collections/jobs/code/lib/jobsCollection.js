...
Jobs = new orion.collection('jobs', {
    singularName: 'job', // The name of one of these items
    pluralName: 'jobs', // The name of more than one of these items
...
/*
    Now we will attach the schema for the jobs collection.
 ...
 */
Jobs.findList = new Meteor.Pagination(Jobs, {
    infinite: true,
